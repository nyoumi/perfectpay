...
export class Services {
  ...
  authentification(email, password) {
    ...
    return new Promise(resolve => {
      this.http.get(environment.server + environment.apilink + params)
        .subscribe(data => {
  ...
  register(UserInfo) {
   ...
   getRegions() {
    ...
    return new Promise(resolve => {
      this.http.get(environment.server + environment.apilink+action)
        .subscribe(data => {
          console.log(data.json()); 
          resolve(data.json());
        }, err => {
  ...
  getDepartments() {
    ...
    return new Promise(resolve => {
      this.http.get(environment.server + environment.apilink+action+"&indexe_users="+idClient+"&secret_code="+secretCode)
        .subscribe(data => {
  ...
  return new Promise(resolve => {
    this.http.get(environment.server + environment.apilink+action+"&indexe_users="+idClient)
      .subscribe(data => {
        //console.log(data._body); 
  ...
  return new Promise(resolve => {
    this.http.get(environment.server + environment.apilink+link)
      .subscribe(data => {
        //console.log(data._body); 
        let result=-1;
        try {
...
async daoGetUsability(): Promise<boolean> {
  ...
  checkRetraitValidation(number) {
    ...
    return new Promise(resolve => {
      this.http.get(environment.server + environment.apilink+action+"&Code_clientExpediteurint="+number)
        .subscribe(data => {
          //console.log(data._body); 
          resolve(data.json());
        }, err => {
  ...
  makeRetraitValidation(number,secretCode,transactionId) {
    ...
    return new Promise(resolve => {
      this.http.get(environment.server + environment.apilink+action+"&Code_clientExpediteur="+number
