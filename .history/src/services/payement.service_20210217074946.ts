        ...
        makePPpayment(userAgent,codeClient,montant,service) {
          ...
          .subscribe(data => {
            ...
            switch(result.succes){
              ...
              break;
              case -1:
              alert2.setMessage("Code marchand incorrect!");
              break;
              case'-2':
              alert2.setMessage("Désolé le numéro de téléphone ne dispose pas de compte perfectpay");
              break;
              case'-3':
              alert2.setMessage("Désolé le solder est insuffisant");
              break;
              default:
